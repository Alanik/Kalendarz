(function ($) {
	...
	function calendarWidget(el, params) {
		...
		calendar += ('<div class="month-nav-container"><div class="calendar-eventSummary-btn"><img src="/images/list-icon.png" alt="triangle"/></div><div class="nav-prev" data-bind="click: $root.showPreviousMonthOnPrevMonthBtnClick" ><img src="/images/Nav/triangle-left.png" alt="triangle"/></div><span class="month-name-calendar">' + monthNames[month] + '</span><div class="nav-next" data-bind="click: $root.showNextMonthOnNextMonthBtnClick" ><img src="/images/Nav/triangle-right.png" alt="triangle"/></div></div>');
