var Program = {
	...
	initialize: function ( indexViewModel, userName ){
		...
		//	{
		//		appViewModel.detailsPageJournalMenu.menuItems.manageOwnPublicEvents.selectedEvents.upcomingTemp.push( kkEvent );
		//	} else
		//	{
		...
		//appViewModel.detailsPageJournalMenu.menuItems.manageOwnPublicEvents.selectedEvents.old( ownPublicEventsOld );
		//appViewModel.detailsPageJournalMenu.menuItems.manageOwnPublicEvents.selectedEvents.upcoming( ownPublicEventsUpcoming );
