    ...
    describe("method checkByPropertyAndOrPredicate(checkArgs)", function () {
        ...
        describe("testing validation + exceptions", function () {
            ...
            it("expect not to throw Error if 'boolSpecifier' property is present in the first checkArg", function () {
                ...
                expect(function () { simpleFilt.checkByPropertyAndOrPredicate(checkArgs) }).not.toThrowError();
            ...
            it("expect Error to be thrown when both 'values' and 'predicate' properties are missing", function () {
                ...
                expect(function () { simpleFilt.checkByPropertyAndOrPredicate(checkArgs) }).toThrowError(Error, "Missing both 'values' and 'predictate' properties. At least one of them must be present to perform proper checks.");
            });
            ...
            it("expect to throw Error when 'prop' property is missing", function () {
                ...
                expect(function () { simpleFilt.checkByPropertyAndOrPredicate(checkArgs) }).toThrowError(Error, "Missing 'prop' property.");
            });
        });
