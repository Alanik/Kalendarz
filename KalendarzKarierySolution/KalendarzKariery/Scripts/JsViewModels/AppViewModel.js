function AppViewModel( date, userName, spinner )
{
	...
	{
		var filteredArray, selectedEventsProp;
		var $menuItemContainer = $( element );
		var $menuItem = $menuItemContainer.find( ".menu-item" );
		var eventKindValue = parseInt( $menuItem.data( "eventkind" ), 10 );

		switch ( self.currentPage )
		{
			case 0:
				selectedEventsProp = self.lobbyPagePublicEventListMenu.menuItems.publicEvents.selectedEvents;
				break;
			case 2:
				switch ( self.detailsPageJournalMenu.selectedMenuItem() )
				{
					case 1:
						selectedEventsProp = self.detailsPageJournalMenu.menuItems.myCalendar.selectedEvents;
						break;
					case 2:
						selectedEventsProp = self.detailsPageJournalMenu.menuItems.manageOwnPublicEvents.selectedEvents;
						break;
					default:
						return;
				}
