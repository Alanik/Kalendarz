...
namespace KalendarzKariery
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include("~/Content/Site.css", "~/Content/EventBlock.css", "~/Content/MediaQueries.css", "~/Content/MediaQueries_ShowHide.css", "~/Scripts/CalendarWidget/CalendarWidget.css", "~/Scripts/Lib/DzieuoJs/Dzieuo.css"));
        }
    }
}